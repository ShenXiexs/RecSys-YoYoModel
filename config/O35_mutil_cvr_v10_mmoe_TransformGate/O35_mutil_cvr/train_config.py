...
class TrainConfig:
    # mkdir -p logs/O35_mutil_cvr
    # nohup bash test.sh O35_mutil_cvr 20250902 > logs/O35_mutil_cvr/nohup_20251022183000.log 2>&1 & tail -f logs/O35_mutil_cvr/nohup_20251022183000.log
    model_version = "O35_mutil_cvr"                    #必填
    model_modul = "models.mutil_cvr_model_fn.model_fn"           #必填
    ...
    predict_columns = list(label_schema.keys()) + list(label_schema.values())    #必填
    ...
    ###
    # infer数据写入的结果表
    infer_table_name = 'adx_dmp.ocpc_offline_shallow_predict'
    ### upload
