...
class TrainConfig:
    # mkdir -p logs/O35_mutil_cvr_v10_mmoe_TransformGate
    # touch logs/O35_mutil_cvr_v10_mmoe_TransformGate/nohup_20251023110000.log
    # nohup bash test.sh O35_mutil_cvr_v10_mmoe_TransformGate 20251001 > logs/O35_mutil_cvr_v10_mmoe_TransformGate/nohup_20251023110000.log 2>&1 & tail -f logs/O35_mutil_cvr_v10_mmoe_TransformGate/nohup_20251023110000.log
    # bash export_after.sh O35_mutil_cvr_v10_mmoe_TransformGate
    ###
    ...
    ###
    model_version = "O35_mutil_cvr_v10_mmoe_TransformGate"                    # required
    model_modul = "models.mutil_cvr_model_fn_v3.model_fn"           # required
    ...
    train_params = {
        ...
        "use_senet": True,
        "senet_type": "TransformGate",
        "senet_config": {
            "feature_index": [0, 1, 37, 48, 60, 70, 80],
            "sigmoid_factor": 1,
            "bBN": True
        },
        "mlp_config": {
        ...
        "mmoe_fusion_type": "mlp",
        "mmoe_fusion_hidden_units": [32],
        "mmoe_config": {
            "num_domains": 3,
            "num_experts": 6,
    ...
    predict_columns = [k for k,v in label_schema.items() if v.endswith("_label")] \
                      ...
                      + ['sd_weight', 'lhb_weight', 'ymfw_weight'] # required
