...
class TrainConfig:
    # mkdir -p logs/O31_v3
    # touch logs/O31_v3/nohup_20250801093000.log
    # nohup bash run.sh O31_v3 20250801 > logs/O31_v3/nohup_20250801093000.log 2>&1 & tail -f logs/O31_v3/nohup_20250801093000.log
    model_version = "O31_v3"
