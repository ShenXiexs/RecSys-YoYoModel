...
class TrainConfig:
    # mkdir -p logs/O35_mutil_cvr_v4
    # nohup bash test.sh O35_mutil_cvr_v4 20250903 > logs/O35_mutil_cvr_v4/nohup_20251023110000.log 2>&1 & tail -f logs/O35_mutil_cvr_v4/nohup_20251023110000.log
    model_version = "O35_mutil_cvr_v4"                    #必填
