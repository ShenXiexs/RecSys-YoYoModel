...
class TrainConfig:
    # mkdir -p logs/O35_mutil_cvr_v15_batch10
    # touch logs/O35_mutil_cvr_v15_batch10/nohup_20251106120000.log
    # nohup bash test.sh O35_mutil_cvr_v15_batch10 20251105 20251109 1 > logs/O35_mutil_cvr_v15_batch10/nohup_20251106120000.log 2>&1 & tail -f logs/O35_mutil_cvr_v15_batch10/nohup_20251106120000.log
    # bash export_after.sh O35_mutil_cvr_v15_batch10
    model_version = "O35_mutil_cvr_v15_batch10"                    #必填
