...
class TrainConfig:
    # mkdir -p logs/O35_mutil_cvr_v10_2
    # touch logs/O35_mutil_cvr_v10_2/nohup_20251023110000.log
    # nohup bash test.sh O35_mutil_cvr_v10_2 20251001 > logs/O35_mutil_cvr_v10_2/nohup_20251023110000.log 2>&1 & tail -f logs/O35_mutil_cvr_v10_2/nohup_20251023110000.log
    # bash export_after.sh O35_mutil_cvr_v10_2
    model_version = "O35_mutil_cvr_v10_2"                    #必填
