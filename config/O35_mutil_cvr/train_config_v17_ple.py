...
class TrainConfig:
    # mkdir -p logs/O35_mutil_cvr_v17
    # touch logs/O35_mutil_cvr_v17/nohup_20251109140000.log
    # nohup bash test.sh O35_mutil_cvr_v17 20251001 > logs/O35_mutil_cvr_v17/nohup_20251109140000.log 2>&1 & tail -f logs/O35_mutil_cvr_v17/nohup_20251109140000.log
    # bash export_after.sh O35_mutil_cvr_v17
    model_version = "O35_mutil_cvr_v17"                    #必填
