...
class TrainConfig:
    # mkdir -p logs/O35_mutil_cvr_v13_batch10
    # touch logs/O35_mutil_cvr_v13_batch10/nohup_2025110517450000.log
    # nohup bash run.sh O35_mutil_cvr_v13_batch10 20251026 20251104 1 > logs/O35_mutil_cvr_v13_batch10/nohup_2025110517450000.log 2>&1 & tail -f logs/O35_mutil_cvr_v13_batch10/nohup_2025110517450000.log
    # bash export_after.sh O35_mutil_cvr_v13_batch10
    # bash infer.sh O35_mutil_cvr_v13_batch10 20251102
    model_version = "O35_mutil_cvr_v13_batch10"                    #必填
    model_modul = "models.mutil_cvr_model_fn_v4.model_fn"           #必填
