...
class TrainConfig:
    # mkdir -p logs/O35_mutil_cvr_v7
    # touch logs/O35_mutil_cvr_v7/nohup_20251023110000.log
    # nohup bash test.sh O35_mutil_cvr_v7 20251029 > logs/O35_mutil_cvr_v7/nohup_20251023110000.log 2>&1 & tail -f logs/O35_mutil_cvr_v7/nohup_20251023110000.log
    model_version = "O35_mutil_cvr_v7"                    #必填
