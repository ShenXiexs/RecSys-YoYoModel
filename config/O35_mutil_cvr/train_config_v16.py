...
class TrainConfig:
    # mkdir -p logs/O35_mutil_cvr_v16
    # touch logs/O35_mutil_cvr_v16/nohup_20251106210000.log
    # nohup bash test.sh O35_mutil_cvr_v16 20251018 > logs/O35_mutil_cvr_v16/nohup_20251106210000.log 2>&1 & tail -f logs/O35_mutil_cvr_v16/nohup_20251106210000.log
    # bash export_after.sh O35_mutil_cvr_v16
    model_version = "O35_mutil_cvr_v16"                    #必填
