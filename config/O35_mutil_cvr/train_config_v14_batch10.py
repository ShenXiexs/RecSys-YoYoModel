...
class TrainConfig:
    # mkdir -p logs/O35_mutil_cvr_v14_batch10
    # touch logs/O35_mutil_cvr_v14_batch10/nohup_202511051180000.log
    # nohup bash run.sh O35_mutil_cvr_v14_batch10 20251025 20251103 1 > logs/O35_mutil_cvr_v14_batch10/nohup_202511051180000.log 2>&1 & tail -f logs/O35_mutil_cvr_v14_batch10/nohup_202511051180000.log
    # bash export_after.sh O35_mutil_cvr_v14_batch10
    model_version = "O35_mutil_cvr_v14_batch10"                    #必填
