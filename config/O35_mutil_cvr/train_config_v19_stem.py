...
class TrainConfig:
    # mkdir -p logs/O35_mutil_cvr_v19_stem
    # touch logs/O35_mutil_cvr_v19_stem/nohup_20251023110000.log
    # nohup bash test.sh O35_mutil_cvr_v19_stem 20251107 >> logs/O35_mutil_cvr_v19_stem/nohup_20251023110000.log 2>&1 & tail -f logs/O35_mutil_cvr_v19_stem/nohup_20251023110000.log
    # bash export_after.sh O35_mutil_cvr_v19_stem
    model_version = "O35_mutil_cvr_v19_stem"                    #必填
