...
class TrainConfig:
    # mkdir -p logs/O35_mutil_cvr_v5
    # nohup bash test.sh O35_mutil_cvr_v5 20250903 > logs/O35_mutil_cvr_v5/nohup_20251023110000.log 2>&1 & tail -f logs/O35_mutil_cvr_v5/nohup_20251023110000.log
    model_version = "O35_mutil_cvr_v5"                    #必填
    model_modul = "models.mutil_cvr_model_fn_v2.model_fn"           #必填
