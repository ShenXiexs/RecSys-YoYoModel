...
class TrainConfig:
    # mkdir -p logs/O35_mutil_cvr_v12_batch10
    # touch logs/O35_mutil_cvr_v12_batch10/nohup_20251023110000.log
    # nohup bash test.sh O35_mutil_cvr_v12_batch10 20251021 20251030 1 > logs/O35_mutil_cvr_v12_batch10/nohup_20251031150000.log 2>&1 & tail -f logs/O35_mutil_cvr_v12_batch10/nohup_20251031150000.log
    # bash export_after.sh O35_mutil_cvr_v12_batch10
    model_version = "O35_mutil_cvr_v12_batch10"                    #必填
