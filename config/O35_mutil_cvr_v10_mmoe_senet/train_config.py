...
class TrainConfig:
    # mkdir -p logs/O35_mutil_cvr_v10_mmoe_senet
    # touch logs/O35_mutil_cvr_v10_mmoe_senet/nohup_20251023110000.log
    # nohup bash test.sh O35_mutil_cvr_v10_mmoe_senet 20251001 > logs/O35_mutil_cvr_v10_mmoe_senet/nohup_20251023110000.log 2>&1 & tail -f logs/O35_mutil_cvr_v10_mmoe_senet/nohup_20251023110000.log
    # bash export_after.sh O35_mutil_cvr_v10_mmoe_senet
    ###
    ...
    ###
    model_version = "O35_mutil_cvr_v10_mmoe_senet"                    # required
    ...
    upload_oss_path = "O35_model_v2"  # Define OSS path for model export                   # required
